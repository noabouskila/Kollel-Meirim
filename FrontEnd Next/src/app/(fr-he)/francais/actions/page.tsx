...
export default function Actions() {
    return (
        <main className=" w-[85%] min-h-screen p-6 mx-auto mt-20 space-y-12">
            ...
            <section className="flex flex-col-reverse items-center gap-6 shadow-xl rounded-xl p-7 bg-blue-200/50 md:flex-row">
                ...
                <div className="relative w-full mb-4 overflow-hidden rounded shadow h-100 md:w-1/2 md:mb-0">
                    <Image
                        src="/KOLLEL5.jpeg"
            ...
            <section className="flex flex-col items-center gap-6 shadow-xl bg-blue-200/50 rounded-xl p-7 md:flex-row">
                <div className="relative w-full mb-4 overflow-hidden rounded shadow h-100 md:w-1/2 md:mb-0">
                    <Image
            ...
            <section className="flex flex-col-reverse items-center gap-6 shadow-xl md:flex-row bg-blue-200/50 rounded-xl p-7">
                <div className="md:w-1/2">
